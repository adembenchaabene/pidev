...
public class FXMLController implements Initializable {
   ...
   @FXML
     ...
     int column = 0;
        ...
        try {
            for (int i = 0; i < salles.size(); i++) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/Ichariot_view/AfficheSalle.fxml"));
    ...
    Parent root = FXMLLoader .load(getClass().getResource("/Ichariot_view/supprimerSalle.fxml"));
    ...
    Parent root = FXMLLoader .load(getClass().getResource("/Ichariot_view/ModifierSalle.fxml"));
    ...
    Parent root = FXMLLoader .load(getClass().getResource("/Ichariot_view/statistiqueSalle.fxml"));
