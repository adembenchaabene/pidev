...
public class ArticFXMLController implements Initializable {
    ...
    void addArticle(ActionEvent event) {
        ...
        Article ah =new Article(33,tfcontenu.getText(),1,tftitre.getText(),Etat.desarchive,tfimage.getText(),0);
    ...
    Parent root = FXMLLoader .load(getClass().getResource("/Ichariot_view/supprimArti.fxml"));
    ...
    Parent root = FXMLLoader .load(getClass().getResource("/Ichariot_view/modifArtic.fxml"));
    ...
    private void stati(ActionEvent event) throws IOException {
        Parent root = FXMLLoader .load(getClass().getResource("/Ichariot_view/stats.fxml"));
