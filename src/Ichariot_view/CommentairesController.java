...
public class CommentairesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            for (int i = 0; i < articles.size(); i++) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/Ichariot_view/afficheclient.fxml"));
    ...
    public void selectedArticle(Article article){
        ...
        try {
            for (int i = 0; i < commentaires.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("/Ichariot_view/graphcomment.fxml"));
    ...
    void ajoutcomment(ActionEvent event) {
        ...
        Commentaire ccl = new Commentaire(1,1,Integer.parseInt(idgetter.getText()),tfcontinu.getText());
        cws.ajouteer(ccl);
        //tfcontinu.getText();
        tfcontinu.setText("");
